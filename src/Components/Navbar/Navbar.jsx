...
const Navbar = ({ setSearchSport }) => {
  ...
  const handleCoachingEnroll=()=>{
    navigate("/allcaochingenroll")
  }

const handleCoachingInsert=()=>{
  navigate("/insertcoaching")
}
const gotoTournaments=()=>{
  setSelectedSection("Tournaments")
navigate("/")
}

const gotoCoaching=()=>{
  setSelectedSection("Coaching")
  navigate("/coaching")
}
        ...
        {userName ? (
          <>
            ...
            >
              ...
              {isAdmin && (
                <>
                  <li onClick={handleCoachingInsert}>Insert Coaching</li>
